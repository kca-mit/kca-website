          ...
          <Splash id="homepage" additionalStyles={['linear-gradient(rgba(50, 13, 13, 0.45), rgba(50, 13, 13, 0.45))']} imageUrl={CoverImg}>
            ...
            <div className="contents">
              <div className="big-letters typography">
                <p>The Korean Cultural Association, formerly known Korean Students Association, welcomes people of all race, gender, sexual orienation, ethnicity, and cultural backgrounds.</p>
                <p>The MIT Korean Cultural Association exists as a non-political club to provide opportunities for members of the MIT community to explore and promote the understanding of the Korean people and culture.</p>
                <p>To this aim, it holds many social, cultural, and informative events throughout the year, open to the entire MIT community.</p>
            ...
            <Row id="culture-show" imageUrl={CultureShowImg}>
              <h2>Culture Show</h2>
              <p>Culture Show is the biggest event KCA organizes annually. We invite students clubs from all schools in Boston to come and help us to introduce the wider MIT community to the Korean culture.</p>
            ...
            <Row flipped id="events" imageUrl={EventsImg}>
              ...
              <p>KSA events are accompained by delicious Korean cultural dishes. Be sure to check out KCA events over Campus Preview Weekend, KBBQ on the week of orientation and gelato icecream at every General Body Meeting.</p>
            ...
            <Row id="misti" imageUrl={MistiImg}>
              ...
              <p>Looking to learn Korean language or about Korean culture? KCA partners with MIT foreign languages department and provides tutors for anyone taking Korean langauge classes at MIT. <Link to={prefixLink("/classes/")}>Check out the classes page to learn more.</Link></p>
